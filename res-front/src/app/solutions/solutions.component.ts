...
export class SolutionsComponent {
  ...
  filters_data  = [
    {name:'Type', values:[['Double conversion online',0],['line interactive',1],['AVR',2]]},
    ...
    {name:'Series', values:[['APC Smart UPS',15],['Easy UPSs 1 PH',16],['APC Back-UPS',17],['SE Easy UPS',18],['APC Line-R',19]]}
  ]
